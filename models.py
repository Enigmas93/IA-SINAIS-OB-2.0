...
class TradingConfig(db.Model):
    ...
    base_timeout = db.Column(db.Integer, default=120)  # Base timeout in seconds
    martingale_timeout_bonus = db.Column(db.Integer, default=30)  # Extra seconds per Martingale level
    max_timeout = db.Column(db.Integer, default=300)  # Maximum timeout in seconds
    
    # Strategy mode configuration
    strategy_mode = db.Column(db.String(20), default='intermediario')  # 'conservador', 'intermediario', 'agressivo'
    min_signal_score = db.Column(db.Float, default=75.0)  # Minimum signal score percentage to trade
